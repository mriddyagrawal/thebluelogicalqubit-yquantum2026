...
# ── Load P9 circuit ──
qc_orig = QuantumCircuit.from_qasm_file('../P9_grand_summit.qasm')
...
# ── Step 1: Canonicalize QASM through Qiskit ──
qasm_str = qasm2.dumps(qc_orig)

# ── Step 2: PyZX simplification (clifford_simp) ──
...
# ── Step 3: Qiskit transpile (basis=[u3, cx], level 3) ──
...
with open("bitstrings.txt", "w") as f:
    f.write(f"P9 Results (PyZX + Qiskit + Aer MPS)\n")
